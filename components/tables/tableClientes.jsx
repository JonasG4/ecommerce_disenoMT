...
export default function TableClientes({ data, setData }) {
  ...
  const filterData = async (filter) => {
    await axios
      .post("/api/users/find/", { filter: filter })
      .then((response) => {
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <div className="flex gap-3">
                        ...
                        <Link
                          href={`/clientes/edit/${item.id_usuario}`}
                          className="font-medium text-purple-600 dark:text-blue-500 hover:underline"
                        >
                          Editar
                        </Link>

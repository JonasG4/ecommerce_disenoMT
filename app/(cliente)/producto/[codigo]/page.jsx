          ...
          <section className="w-full flex flex-col gap-1">
            ...
            <div className="flex gap-4 items-center">
              <p className="font-semibold">
                SKU: <span className="font-normal">2610415</span>{" "}
              </p>
            ...
            <div className="mt-2 flex gap-8 items-center">
              <p className="text-2xl font-black text-gray-600 flex flex-col leading-[24px]">
                <span className="text-[16px] font-normal">Normal</span>
                <span className="text-xl line-through font-light">$485.55</span>
              </p>
            ...
            <p className="">
              ull 1.52x 2.03m – Base con 9 patas • Cubierta de soporte
              ergonómico semifirme • Sistema Pillow Top con tela transpirable 3D
              • Tela europea antimosquito y antibacterial, evita el crecimiento
              de bacterias y aleja los mosquitos de tu colchón • Sistema de
              soporte perimetral con espuma firme Foam Encased • Resortes
              Bonnell Plus de alto soporte • Sistema con espumas Aire Fresh
            </p>

...
export default function dashboard() {
  return (
    <div className="p-7 w-full h-[92vh] flex flex-col gap-4 overflow-auto scroll scrollbar-thumb-purple-400 scrollbar-track-slate-200 scrollbar-thin scrollbar-corner-current">
      <div>
      ...
      <section className="w-full flex md:gap-4 movile:flex-wrap sm:gap-5 lg:flex-nowrap lg:gap-10">
        {/* TOTAL DE VENTAS */}
        <div className="h-[110px] w-full bg-gray-50 rounded-md shadow-md p-4 flex items-center gap-4 flex-wrap">
      ...
      <section className="flex gap-5 w-full movile:flex-wrap lg:flex-nowrap">
        <div className="overflow-x-auto w-full h-[330px] rounded-md p-5 shadow-lg bg-gray-50 flex flex-col justify-center">
      ...
      <section className="w-full bg-gray-50 rounded-md shadow-lg p-5 flex flex-col gap-4">
        <h4 className="text-xl font-bold text-gray-700">
          Últimos pedidos
        </h4>
        <section className="overflow-auto relative scrollbar-thin scrollbar-track-gray-300 scrollbar-thumb-purple-600 scrollbar-thumb-rounded-full">

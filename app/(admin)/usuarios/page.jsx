              ...
              {usersList.map((item, index) => {
                return (
                  ...
                  >
                    ...
                    <td className="w-[350px] py-4 px-6">{item.apellido}</td>
                    <td className="w-[150px] py-4 px-6">{item.telefono}</td>
                    <td className="w-[350px] py-4 px-6">{item.email}</td>
                    <td className="w-[160px] py-4 px-6 font-bold text-xs">
                      {item.role}
                    </td>
                    ...
                    <td className="w-[150px] py-4 px-6">
                      <div className="flex gap-3">
                        ...
                        <Link
                          href={`/usuarios/${item.id_usuario}/edit`}
                          className="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        >
                          Editar
                        </Link>

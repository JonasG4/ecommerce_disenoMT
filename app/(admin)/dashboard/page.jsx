...
export default function dashboard() {
  return (
    <div className="p-7 w-full h-[92vh] flex flex-col gap-4 overflow-auto scroll scrollbar-thumb-blue-400 scrollbar-track-slate-200 scrollbar-thin scrollbar-corner-current">
      <div>
      ...
      <section className="w-full bg-gray-50 rounded-md shadow-lg p-5 flex flex-col gap-4">
        ...
        <section className="overflow-auto relative scrollbar-thin scrollbar-track-gray-300 scrollbar-thumb-blue-600 scrollbar-thumb-rounded-full">
